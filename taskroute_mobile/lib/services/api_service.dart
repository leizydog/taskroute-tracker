...
class ApiService {
  ...
  // Production API URL (for deployed APK)
  ...
  Map<String, String> get _headers {
    ...
    if (_authToken != null) {
      ...
      print(
        'Authorization header added: Bearer ${_authToken!.substring(0, 20)}...',
      );
    } else {
  ...
  Future<http.Response> startTask(
    int taskId,
  ...
  Future<http.Response> getLocationHistory({
    int? taskId,
    int limit = 100,
  }) async {
