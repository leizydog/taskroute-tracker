...
const Login = () => {
  ...
  return (
    /* Outer wrapper needs `relative` so the absolute bg sits behind everything */
    <div className="min-h-screen relative">
      {/* Background layer: absolute full-screen gradient behind the content */}
      <div
        className="absolute inset-0 bg-gradient-to-r from-blue-900 to-white -z-10"
        aria-hidden="true"
      />

      {/* Centering container (keeps the card separated from the bg) */}
      <div className="flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow-xl rounded-2xl p-10 max-w-md w-full transform transition-all hover:shadow-2xl z-20">
